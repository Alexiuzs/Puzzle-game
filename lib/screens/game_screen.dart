                      ...
                      if (notifier.activeDefinition != null)
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: () => notifier
                                .clearActiveDefinition(), // Dismiss when tapping outside the popup
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () =>
                                            notifier.clearActiveDefinition(),
                                  ...
                                  Builder(
                                    builder: (context) {
                                      ...
                                      final proverbMatch = RegExp(
                                        r"(\s'.*'\s\(Xam-Xamu Suleymaan Saar.*)$",
                                      );
                                      final match = proverbMatch.firstMatch(
                                        defText,
                                      );

                                      if (match != null) {
                                        final proverb = match.group(1)!.trim();
                                        final definition = defText
